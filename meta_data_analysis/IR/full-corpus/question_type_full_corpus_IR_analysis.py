...
def main():
    ...
    for spec in args.model:
        ...
        if "Question_type" not in df.columns:
            raise ValueError("Column 'Question_type' missing in full corpus file.")
        ...
        print(f"\n=== {name} — nDCG/MAP by Question_type (full corpus) ===")
